...
@if (isset($akses->sales_return))
    @if ($akses->sales_return->view == 1)
        <input type="hidden" id="update" value="{{ $akses->sales_return->update }}">
        <input type="hidden" id="delete" value="{{ $akses->sales_return->delete }}">
