...
<input type="hidden" id="url" value="{{ isset($data) ? route('sales-return-edit') : route('sales-return-add') }}">
...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="text-end mt-3">
            ...
            <button type="reset" onclick="SalesReturn.back(this, event)" class="btn btn-secondary waves-effect">
                Cancel
            </button>
        </div>
    </div>
