...
@if (isset($akses->chart_of_account))
    @if ($akses->chart_of_account->view == 1)
        <input type="hidden" id="update" value="{{ $akses->chart_of_account->update }}">
        <input type="hidden" id="delete" value="{{ $akses->chart_of_account->delete }}">
