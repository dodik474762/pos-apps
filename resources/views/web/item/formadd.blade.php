...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                {{-- <form onsubmit="Item.submit(this, event)" enctype="multipart/form-data"> --}}
                <form action="{{ route('item-submit') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="mb-3">
                                ...
                                <div>
                                    <input type="text" onkeyup="Item.setNumeric(this, event)" min="0" id="purchase_price"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    {{-- <button class="btn btn-outline-secondary" type="button" id="button-addon1"
                                        onclick="Item.addFile(this)">Choose
                                        File</button> --}}
                                    @if (isset($data->id))
                                        @if ($data->files != '')
                    ...
                    <div class="text-end">
                        <div>
                            {{-- <button type="submit" onclick="Item.submit(this, event)"
                            ...
                            <button type="reset" onclick="Item.cancel(this, event)" class="btn btn waves-effect">
                                Cancel
                            </button>
                        </div>
                    </div>
