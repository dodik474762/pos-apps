                    ...
                    <div class="card-body pt-0">
                        <div>
                            <ul class="nav nav-tabs nav-tabs-custom nav-success mb-3" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link All py-3" data-bs-toggle="tab" id="AllInvoice"
                                        href="#list-data-invoice" role="tab" aria-selected="false">
                                        <i class="ri-store-2-fill me-1 align-bottom"></i> All {{ $title }} from
                                        Tagihan
                                    </a>
                                </li>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="list-data-invoice">
                                    <div class="table-responsive table-card mb-1">
                                        <table class="table table-nowrap align-middle" id="table-data-invoice">
                                            <thead class="text-muted table-light">
                                                <tr class="text-uppercase">
                                                    <th>No</th>
                                                    <th>Invoice Number</th>
