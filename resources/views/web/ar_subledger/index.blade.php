@if (isset($akses->ar_subledger))
    @if ($akses->ar_subledger->view == 1)
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card border-0 shadow-sm" id="arSubledgerList">
                    <div class="card-header bg-transparent border-0 pb-3">
                        <div class="row align-items-center gy-3">
                            <div class="col-sm">
                                <h5 class="card-title mb-0 fw-semibold">{{ $title }} List</h5>
                                <p class="text-muted mb-0 small">Daftar piutang customer</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="table-responsive">
                            <table class="table table-nowrap align-middle" id="table-ar">
