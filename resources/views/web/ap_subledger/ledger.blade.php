    ...
    @if ($akses->ap_subledger->view == 1)
                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ url('transaksi/ap_subledger') }}">{{ $title_parent }}</a></li>
                            <li class="breadcrumb-item"><a href="{{ url('transaksi/ap_subledger') }}">AP Subledger</a></li>
                            <li class="breadcrumb-item active">{{ $supplier->code }} - {{ $supplier->nama_vendor }}</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-transparent border-0 pb-3">
                        ...
                        <p class="text-muted mb-0 small">Filter data ledger supplier</p>
                    </div>
                        ...
                        <form id="filter-form" class="row g-3">
                            ...
                            <div class="col-xxl-3 col-sm-6">
                                ...
                                <input type="text" class="form-control" readonly
                                    value="{{ $supplier->code }} - {{ $supplier->nama_vendor }}">
                            </div>
                            <div class="col-xxl-12 col-sm-12 text-end pt-2">
                                <a href="{{ url('transaksi/ap_subledger') }}" class="btn btn-outline-secondary">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-transparent border-0 pb-3">
                        <h5 class="card-title mb-0 fw-semibold">Supplier Ledger</h5>
                        <p class="text-muted mb-0 small">Riwayat transaksi {{ $supplier->code }} - {{ $supplier->nama_vendor }}</p>
                    </div>
                    <div class="card-body pt-0">
