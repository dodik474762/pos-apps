@if (isset($akses->pasar))
    @if ($akses->pasar->view == 1)
        <input type="hidden" id="update" value="{{ $akses->pasar->update }}">
        <input type="hidden" id="delete" value="{{ $akses->pasar->delete }}">
