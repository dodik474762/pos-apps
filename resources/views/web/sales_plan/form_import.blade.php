...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <form action="{{ url('/api/transaksi/sales_plan/submit_import') }}" method="POST" enctype="multipart/form-data" id="form-product">
                     @csrf
                    ...
                    <div class="text-end">
                        <div>
                            <button type="submit"
                                onclick="SalesPlan.submitImport(this, event)"
                                class="btn btn-success waves-effect waves-light me-1">
                                Submit
                            </button>
                            <button type="reset" onclick="SalesPlan.cancel(this, event)" class="btn btn waves-effect">
                                Cancel
                            </button>
                        </div>
                    </div>
