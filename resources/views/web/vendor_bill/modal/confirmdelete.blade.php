    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                @if ($hasActiveJournal)
                    <div class="alert alert-warning mb-3">
                        ...
                        <p class="mb-0">
                            Vendor payment <b>{{ ! empty($payment_number) ? $payment_number : '' }}</b>
                    ...
                    <p class="mb-0">
                        ...
                        <b>REVERSED</b>, vendor payment ini dapat dihapus.
                    </p>
                @else
                    ...
                    @if (! $isDraft)
                        <div class="alert alert-warning mb-3">
                            ...
                            <p class="mb-0">
                                Vendor payment <b>{{ ! empty($payment_number) ? $payment_number : '' }}</b>
                                berstatus <b>{{ ! empty($payment_status) ? $payment_status : '' }}</b> sehingga
                                dampaknya sudah pernah berjalan ke modul lain. Hapus data hanya diperbolehkan
                                bila jurnal pembayaran telah direversal.
                            </p>
                        </div>
                        ...
                        @else
                            <p class="mb-0">
                                Bila jurnal untuk vendor payment ini sudah pernah dibuat, jurnal tersebut harus
            ...
            <div class="modal-footer">
                ...
                @else
                    <button class="btn btn-primary" onclick="VendorBill.confirmDelete(this)"
