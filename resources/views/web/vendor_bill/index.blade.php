...
@if (isset($akses->vendor_bill))
    @if ($akses->vendor_bill->view == 1)
        <input type="hidden" id="update" value="{{ $akses->vendor_bill->update }}">
        <input type="hidden" id="delete" value="{{ $akses->vendor_bill->delete }}">
