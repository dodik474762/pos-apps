...
@if (isset($akses->good_receipt))
    @if ($akses->good_receipt->view == 1)
        <input type="hidden" id="update" value="{{ $akses->good_receipt->update }}">
        <input type="hidden" id="delete" value="{{ $akses->good_receipt->delete }}">
