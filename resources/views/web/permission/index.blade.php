@if (isset($akses->permissions))
    @if ($akses->permissions->view == 1)
        <input type="hidden" id="update" value="{{ $akses->permissions->update }}">
        <input type="hidden" id="delete" value="{{ $akses->permissions->delete }}">
