        ...
        <div class="card">
            <div class="card-body">
                <form onsubmit="PurchaseOrder.submit(this, event)">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" id="est_received_date" class="form-control required"
                                    error="Tanggal PO"
                        ...
                        <table class="table table-bordered" id="table-items">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th class="d-none" style="width: 12%">Pajak</th> <!-- ✅ Kolom baru -->
                            ...
                            <tbody id="detail-body">
                                        ...
                                        <tr class="input" data_id="{{ $item->id }}">
                                            <td>
                                                <div class="input-group">
                                                    ...
                                                    <input disabled id="product" name="product" type="text"
                                            ...
                                            <td><input type="number" class="form-control" id="qty"
                                                    ...
                                                    onkeyup="PurchaseOrder.calcRow(this)"></td>
                                            <td><input type="number" class="form-control" id="price"
                                                    value="{{ $item->purchase_price }}"
                                                    onkeyup="PurchaseOrder.calcRow(this)"></td>
                                            <td><input type="number" class="form-control" id="disc_persen"
                                                    value="{{ $item->diskon_persen }}"
                                                    onkeyup="PurchaseOrder.calcRow(this)"></td>
                                            <td><input type="number" class="form-control" id="disc_nominal"
                                                    value="{{ $item->diskon_nominal }}"
                                                    onkeyup="PurchaseOrder.calcRow(this)"></td>
                                            <td class="d-none">
                                                <select class="form-control" id="tax"
                                                    onchange="PurchaseOrder.calcRow(this)">
                                            ...
                                            <td class="text-center">
                                                <button type="button" class="btn btn-sm btn-danger"
                                                    onclick="PurchaseOrder.removeRow(this)"><i
                                ...
                                @else
                                    <tr class="input" data_id="">
                                        ...
                                        <td><input type="number" class="form-control" id="qty" value="1"
                                                min="1" onkeyup="PurchaseOrder.calcRow(this)"></td>
                                        <td><input type="number" class="form-control" id="price" value="0"
                                                onkeyup="PurchaseOrder.calcRow(this)"></td>
                                        <td><input type="number" class="form-control" id="disc_persen"
                                                value="0" onkeyup="PurchaseOrder.calcRow(this)"></td>
                                        <td><input type="number" class="form-control" id="disc_nominal"
                                                value="0" onkeyup="PurchaseOrder.calcRow(this)"></td>
                                        <td class="d-none">
                                            <select class="form-control" id="tax"
                    ...
                    <button type="button" class="btn btn-sm btn-primary mt-2" onclick="PurchaseOrder.addRow()">+
                        Tambah Barang</button>

                    <div class="text-end mt-4">
                        <h5>Total: <span
                                id="total-harga">{{ isset($data->grand_total) ? $data->grand_total : 0 }}</span></h5>
                    </div>
        ...
        <div class="text-end">
            @if (isset($id))
                @if ($data->status == 'draft')
                    <button type="submit" onclick="PurchaseOrder.submit(this, event)"
