...
@if (isset($akses->purchase_order))
    @if ($akses->purchase_order->view == 1)
        <input type="hidden" id="update" value="{{ $akses->purchase_order->update }}">
        <input type="hidden" id="delete" value="{{ $akses->purchase_order->delete }}">
