...
@if (isset($akses->work_hour))
    @if ($akses->work_hour->view == 1)
        <input type="hidden" id="update" value="{{ $akses->work_hour->update }}">
        <input type="hidden" id="delete" value="{{ $akses->work_hour->delete }}">
                    ...
                    <div class="card-header border-0">
                        <div class="row align-items-center gy-3">
                            ...
                            <div class="col-sm-auto">
                                @if ($akses->work_hour->insert == 1)
                                    <div class="d-flex gap-1 flex-wrap">
                                        <a type="button" class="btn btn-success add-btn" data-bs-toggle="modal"
                                            id="create-btn" href="javascript:void(0);" onclick="WorkingHour.add(this, event)"><i
                                        ...
                                        <table class="table table-nowrap align-middle" id="table-data">
                                            <thead class="text-muted table-light">
                                                <tr class="text-uppercase">
                                                    ...
                                                    <th class="sort">Start Hour</th>
                                                    <th class="sort">End Hour</th>
