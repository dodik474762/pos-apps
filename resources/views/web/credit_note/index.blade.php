...
@if (isset($akses->credit_note))
    @if ($akses->credit_note->view == 1)
        <input type="hidden" id="update" value="{{ $akses->credit_note->update }}">
        <input type="hidden" id="delete" value="{{ $akses->credit_note->delete }}">
