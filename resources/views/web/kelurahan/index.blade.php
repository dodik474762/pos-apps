...
@if (isset($akses->kelurahan))
    @if ($akses->kelurahan->view == 1)
        <input type="hidden" id="update" value="{{ $akses->kelurahan->update }}">
        <input type="hidden" id="delete" value="{{ $akses->kelurahan->delete }}">
