@if (isset($akses->vendor))
    @if ($akses->vendor->view == 1)
        <input type="hidden" id="update" value="{{ $akses->vendor->update }}">
        <input type="hidden" id="delete" value="{{ $akses->vendor->delete }}">
