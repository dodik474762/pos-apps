...
@if (isset($akses->province))
    @if ($akses->province->view == 1)
        <input type="hidden" id="update" value="{{ $akses->province->update }}">
        <input type="hidden" id="delete" value="{{ $akses->province->delete }}">
                    ...
                    <div class="card-header border-0">
                        <div class="row align-items-center gy-3">
                            ...
                            <div class="col-sm-auto">
                                @if ($akses->province->insert == 1)
                                    <div class="d-flex gap-1 flex-wrap">
                                        <a type="button" class="btn btn-success add-btn" data-bs-toggle="modal"
                                            id="create-btn" href="javascript:void(0);" onclick="Province.add(this, event)"><i
