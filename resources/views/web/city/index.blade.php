...
@if (isset($akses->city))
    @if ($akses->city->view == 1)
        <input type="hidden" id="update" value="{{ $akses->city->update }}">
        <input type="hidden" id="delete" value="{{ $akses->city->delete }}">
