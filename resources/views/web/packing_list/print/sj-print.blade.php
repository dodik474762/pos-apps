...
<head>
    <meta charset="utf-8">
    <title>Surat Jalan - {{ $data->code }}</title>
...
<body>
    ...
    <table class="header-table" style="width:100%;">
        <tr>
            ...
            <td style="text-align:right;">
                <h4 style="margin:0; padding:0;">Surat Jalan</h4>
                <small>No: {{ $data->sj_number }}</small>
            </td>
        </tr>
    </table>
    ...
    <table class="no-border" style="width:100%;">
        <tr>
            ...
            <td style="padding-left:40px;"><strong>Tanggal SJ:</strong>
                {{ $data->sj_date =='' ? '-' :date('d/m/Y', strtotime($data->sj_date)) }}</td>
        </tr>
        <tr>
    ...
    <table class="table-detail">
        ...
        <tfoot>
            <tr>
                <td colspan="9" class="text-right"><strong>Total DO</strong></td>
                <td class="text-right">
