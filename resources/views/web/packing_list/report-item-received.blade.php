@if (isset($akses->barang_kembali))
    @if ($akses->barang_kembali->view == 1)
                        ...
                        <form class="">
                            <div class="row g-3">
                                ...
                                <div class="col-xxl-2 col-sm-4">
                                    <div>
                                        <input type="date" class="form-control" data-provider="flatpickr"
                                            data-date-format="d M, Y" data-range-date="true" id="start-date"
                                ...
                                <div class="col-xxl-2 col-sm-4">
                                    <div>
                                        <input type="date" class="form-control" data-provider="flatpickr"
                                            data-date-format="d M, Y" data-range-date="true" id="end-date"
                                            placeholder="Select date" value="{{ date('Y-m-d') }}">
                                    </div>
                                </div>
                                <div class="col-xxl-1 col-sm-4">
                                    <div>
                                        <button type="button" class="btn btn-primary w-100"
                                            onclick="PackingList.getDataReportReceived();"> <i
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="list-data">
                                    <div class="table-responsive table-card mb-1">
                                        <table class="table table-nowrap align-middle" id="table-data-report-item">
