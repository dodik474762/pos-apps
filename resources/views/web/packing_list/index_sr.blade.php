...
@if (isset($akses->packing_pickup_retur))
    @if ($akses->packing_pickup_retur->view == 1)
        <input type="hidden" id="update" value="{{ $akses->packing_pickup_retur->update }}">
        <input type="hidden" id="delete" value="{{ $akses->packing_pickup_retur->delete }}">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="list-data">
                                    <div class="table-responsive table-card mb-1">
                                        <table class="table table-nowrap align-middle" id="table-data-sr">
