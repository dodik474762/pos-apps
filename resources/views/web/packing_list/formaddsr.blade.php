...
<input type="hidden" id="url"
       value="{{ isset($data) ? route('packing-list-sr-edit') : route('packing-list-sr-add') }}">
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">
                {{ isset($data) ? 'Edit Packing List Pickup Retur' : 'Create Packing List Pickup Retur' }}
            </h4>

            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="#">Transaction</a></li>
                    <li class="breadcrumb-item active">Packing List Pickup Retur</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <form onsubmit="PackingList.submitSr(this, event)">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="button" class="btn btn-primary btn-sm"
                                onclick="PackingList.showModalSR()">Tambah Sales Return</button>
                    </div>
        ...
        <div class="text-end mt-3">
            <button type="submit" onclick="PackingList.submitSr(this, event)"
                    class="btn btn-success waves-effect waves-light me-1">
                Submit
            </button>

            <button type="reset" onclick="PackingList.backSr(this, event)"
