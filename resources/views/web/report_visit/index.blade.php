@if (isset($akses->report_detail_kunjungan))
    @if ($akses->report_detail_kunjungan->view == 1)
        <input type="hidden" id="update" value="{{ $akses->report_detail_kunjungan->update }}">
        <input type="hidden" id="delete" value="{{ $akses->report_detail_kunjungan->delete }}">
                    ...
                    <div class="card-header border-0">
                        <div class="row align-items-center gy-3">
                            ...
                            <div class="col-sm-auto">
                                @if ($akses->report_detail_kunjungan->insert == 1)
                                @endif
                            </div>
                        </div>
                    </div>
                                        ...
                                        <table class="table table-nowrap align-middle" id="table-data">
                                            <thead class="text-muted table-light">
                                                <tr class="text-uppercase">
                                                    ...
                                                    <th>Status Visit</th>
                                                    <th>Waktu Lama di Jalan</th>
                                                    <th>Jam Masuk Toko</th>
                                                    <th>Jam Keluar Toko</th>
                                                </tr>
                                            </thead>
                                            <tbody class="list">
                                            </tbody>
