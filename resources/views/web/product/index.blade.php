@if (isset($akses->product))
    @if ($akses->product->view == 1)
        <input type="hidden" id="update" value="{{ $akses->product->update }}">
        <input type="hidden" id="delete" value="{{ $akses->product->delete }}">
