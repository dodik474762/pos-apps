    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                @if ($hasActiveJournal)
                    <div class="alert alert-warning mb-3">
                        ...
                        <p class="mb-0">
                            Delivery Order <b>{{ $do_number }}</b> memiliki jurnal HPP
                    ...
                    <p class="mb-0">
                        ...
                        <b>REVERSED</b>, Delivery Order ini dapat dihapus.
                    </p>
                @else
                    ...
                    @if (! $isDraft)
                        <div class="alert alert-warning mb-3">
                            ...
                            <p class="mb-0">
                                Delivery Order <b>{{ $do_number }}</b> berstatus <b>{{ $do_status }}</b> sehingga
                                dampaknya sudah pernah berjalan ke modul lain. Hapus data hanya diperbolehkan bila
                                jurnal HPP telah direversal.
                            </p>
                        </div>

                        @if ($journalNo != '' && $journalStatus == 'REVERSED')
                            <p class="text-muted mb-0">
                                Jurnal HPP <b>{{ $journal_no }}</b> sudah berstatus <b>REVERSED</b>, penghapusan
                                dapat dilanjutkan.
                            </p>
                        @else
                            <p class="mb-0">
                                Bila jurnal HPP untuk Delivery Order ini sudah pernah dibuat, jurnal tersebut
            ...
            <div class="modal-footer">
                ...
                @else
                    <button class="btn btn-primary" onclick="DeliveryOrder.confirmDelete(this)"
