...
@if (isset($akses->delivery_order))
    @if ($akses->delivery_order->view == 1)
        <input type="hidden" id="update" value="{{ $akses->delivery_order->update }}">
        <input type="hidden" id="delete" value="{{ $akses->delivery_order->delete }}">
