...
@if (isset($akses->day_off))
    @if ($akses->day_off->view == 1)
        <input type="hidden" id="update" value="{{ $akses->day_off->update }}">
        <input type="hidden" id="delete" value="{{ $akses->day_off->delete }}">
                    ...
                    <div class="card-header border-0">
                        <div class="row align-items-center gy-3">
                            ...
                            <div class="col-sm-auto">
                                @if ($akses->day_off->insert == 1)
                                    <div class="d-flex gap-1 flex-wrap">
                                        <a type="button" class="btn btn-success add-btn" data-bs-toggle="modal"
                                            id="create-btn" href="javascript:void(0);" onclick="Dayoff.add(this, event)"><i
