@if (isset($akses->account_types))
    @if ($akses->account_types->view == 1)
        <input type="hidden" id="update" value="{{ $akses->account_types->update }}">
        <input type="hidden" id="delete" value="{{ $akses->account_types->delete }}">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card" id="accountTypesList">
