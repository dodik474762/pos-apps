@if (isset($akses->accounts))
    @if ($akses->accounts->view == 1)
        <input type="hidden" id="update" value="{{ $akses->accounts->update }}">
        <input type="hidden" id="delete" value="{{ $akses->accounts->delete }}">
