@if (isset($akses->journals))
    @if ($akses->journals->view == 1)
        <input type="hidden" id="update" value="{{ $akses->journals->update }}">
        <input type="hidden" id="delete" value="{{ $akses->journals->delete }}">
        ...
        <button type="button" id="confirm-post-btn" class="" style="display: none;" data-bs-toggle="modal"
            data-bs-target="#konfirmasi-post"></button>
        <button type="button" id="confirm-reversal-btn" class="" style="display: none;" data-bs-toggle="modal"
            data-bs-target="#konfirmasi-reversal"></button>
        <div id="content-confirm-delete"></div>
        <div id="content-confirm-post"></div>
        <div id="content-confirm-reversal"></div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card" id="journalsList">
                            ...
                            <ul class="nav nav-tabs nav-tabs-custom nav-success mb-3" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active All py-3" data-bs-toggle="tab" id="All"
                                        ...
                                        <i class="ri-money-dollar-box-line me-1 align-bottom"></i> All {{ $title }}
                                    </a>
                                </li>
                            </ul>
