    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                @if ($hasActiveJournal)
                    <div class="alert alert-warning mb-3">
                        ...
                        <p class="mb-0">
                            Purchase Return <b>{{ ! empty($return_number) ? $return_number : '' }}</b>
                    ...
                    <p class="mb-0">
                        ...
                        <b>REVERSED</b>, purchase return ini dapat dihapus.
                    </p>
                @else
                    ...
                    @if (! $isDraft)
                        <div class="alert alert-warning mb-3">
                            ...
                            <p class="mb-0">
                                Purchase Return <b>{{ ! empty($return_number) ? $return_number : '' }}</b>
                                berstatus <b>{{ ! empty($return_status) ? $return_status : '' }}</b>
                                sehingga dampaknya sudah pernah berjalan ke modul lain. Hapus data hanya
                                diperbolehkan bila jurnal purchase return telah direversal.
                            </p>
                        </div>
                        <p class="mb-0">
                            Bila jurnal untuk purchase return ini sudah pernah dibuat, jurnal tersebut harus
            ...
            <div class="modal-footer">
                ...
                @else
                    <button class="btn btn-primary" onclick="PurchaseReturn.confirmDelete(this)"
