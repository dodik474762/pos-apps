...
@if (isset($akses->purchase_return))
    @if ($akses->purchase_return->view == 1)
        <input type="hidden" id="update" value="{{ $akses->purchase_return->update }}">
        <input type="hidden" id="delete" value="{{ $akses->purchase_return->delete }}">
