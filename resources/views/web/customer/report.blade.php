@if (isset($akses->report_customer))
    @if ($akses->report_customer->view == 1)
        <input type="hidden" id="update" value="{{ $akses->report_customer->update }}">
        <input type="hidden" id="delete" value="{{ $akses->report_customer->delete }}">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="list-data">
                                    <div class="table-responsive table-card mb-1">
                                        <table class="table table-nowrap align-middle" id="table-data-customer-report">
