@if (isset($akses->sessions))
    @if ($akses->sessions->view == 1)
        <input type="hidden" id="update" value="{{ $akses->sessions->update }}">
        <input type="hidden" id="delete" value="{{ $akses->sessions->delete }}">
