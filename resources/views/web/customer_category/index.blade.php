...
@if (isset($akses->customer_category))
    @if ($akses->customer_category->view == 1)
        <input type="hidden" id="update" value="{{ $akses->customer_category->update }}">
        <input type="hidden" id="delete" value="{{ $akses->customer_category->delete }}">
                    ...
                    <div class="card-header border-0">
                        <div class="row align-items-center gy-3">
                            ...
                            <div class="col-sm-auto">
                                @if ($akses->customer_category->insert == 1)
                                    <div class="d-flex gap-1 flex-wrap">
                                        <a type="button" class="btn btn-success add-btn" data-bs-toggle="modal"
                                            id="create-btn" href="javascript:void(0);" onclick="CustomerCategory.add(this, event)"><i
                                        ...
                                        <table class="table table-nowrap align-middle" id="table-data">
                                            <thead class="text-muted table-light">
                                                <tr class="text-uppercase">
                                                    ...
                                                    <th class="sort" data-sort="akses">Category</th>
