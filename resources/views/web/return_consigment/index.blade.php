...
@if (isset($akses->return_consigment))
    @if ($akses->return_consigment->view == 1)
        <input type="hidden" id="update" value="{{ $akses->return_consigment->update }}">
        <input type="hidden" id="delete" value="{{ $akses->return_consigment->delete }}">
