...
@if (isset($akses->roles))
    @if ($akses->roles->view == 1)
        <input type="hidden" id="update" value="{{ $akses->roles->update }}">
        <input type="hidden" id="delete" value="{{ $akses->roles->delete }}">
                    ...
                    <div class="card-header border-0">
                        <div class="row align-items-center gy-3">
                            ...
                            <div class="col-sm-auto">
                                @if ($akses->roles->insert == 1)
                                    <div class="d-flex gap-1 flex-wrap">
                                        <a type="button" class="btn btn-success add-btn" data-bs-toggle="modal"
                                            id="create-btn" href="javascript:void(0);" onclick="Roles.add(this, event)"><i
                                        ...
                                        <table class="table table-nowrap align-middle" id="table-data">
                                            <thead class="text-muted table-light">
                                                <tr class="text-uppercase">
                                                    ...
                                                    <th class="sort" data-sort="akses">Nama Akses</th>
