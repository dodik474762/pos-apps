...
@if (isset($akses->report_penjualan))
    @if ($akses->report_penjualan->view == 1)
        ...
        <input type="hidden" id="delete" value="{{ $akses->report_penjualan->delete }}">
                    ...
                    <div class="card-header border-0">
                        <div class="row align-items-center gy-3">
                            ...
                            <div class="col-sm-auto">
                                @if ($akses->report_penjualan->insert == 1)
                                @endif
                            </div>
                        </div>
                    </div>
                                        ...
                                        <table class="table table-nowrap align-middle" id="table-data">
                                            <thead class="text-muted table-light">
                                                <tr class="text-uppercase">
                                                    ...
                                                    <th>TIPE TRANS</th>
                                                    <th>GROSSAMOUNT</th>
                                                    <th>LINE DISCOUNT 1</th>
                                                    <th>LINE DISCOUNT 2</th>
                                                    <th>LINE DISCOUNT 3</th>
