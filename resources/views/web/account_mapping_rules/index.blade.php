@if (isset($akses->account_mapping_rules))
    @if ($akses->account_mapping_rules->view == 1)
        <input type="hidden" id="update" value="{{ $akses->account_mapping_rules->update }}">
        <input type="hidden" id="delete" value="{{ $akses->account_mapping_rules->delete }}">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card" id="accountMappingRulesList">
