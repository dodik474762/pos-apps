...
<head>
    ...
    <!--datatable css-->
    <link rel="stylesheet"
        href="{{ asset('main_template/assets/libs/cdn.datatables.net/1.11.5/css/dataTables.bootstrap5.min.css') }}" />
    <!--datatable responsive css-->
    <link rel="stylesheet"
        href="{{ asset('main_template/assets/libs/cdn.datatables.net/responsive/2.2.9/css/responsive.bootstrap.min.css') }}" />

    <link rel="stylesheet"
        href="{{ asset('main_template/assets/libs/cdn.datatables.net/buttons/2.2.2/css/buttons.dataTables.min.css') }}">
    <link rel="stylesheet"
        href="{{ asset('main_template/assets/libs/cdn.datatables.net/fixedheader/css/fixedColumns.dataTables.min.css') }}">
    <link rel="stylesheet"
        href="{{ asset('main_template/assets/libs/cdn.datatables.net/fixedheader/css/fixedHeader.dataTables.min.css') }}">
    <link rel="stylesheet"
        href="{{ asset('main_template/assets/libs/cdn.datatables.net/1.11.5/css/rowgroup.min.css') }}" />
    <link rel="stylesheet"
        href="{{ asset('main_template/assets/libs/cdn.jsdelivr.net/npm/flatpicker/flatpicker.css') }}">
    ...
    <link href="{{ asset('main_template/assets/libs/swiper/swiper-bundle.min.css') }}" rel="stylesheet"
        type="text/css" />
    <link
        href="{{ asset('main_template/assets/libs/cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css') }}"
    ...
    <link href="{{ asset('assets/css/template.css?v=' . date('YmdHis')) }}" id="app-style" rel="stylesheet"
        type="text/css" />
    <link rel="stylesheet" href="{{ asset('assets/css/menu-card.css?v=' . date('YmdHis')) }}" />
...
<body>
    ...
    <div id="layout-wrapper">
        ...
        @include('web.template.sidebarcard')
        <!-- Vertical Overlay-->
    ...
    <script src="{{ asset('main_template/assets/libs/cdn.datatables.net/1.11.5/js/dataTables.bootstrap5.min.js') }}">
    </script>
    <script src="{{ asset('main_template/assets/libs/cdn.datatables.net/1.11.5/js/rowgroup.min.js') }}"></script>
    <script
        src="{{ asset('main_template/assets/libs/cdn.datatables.net/responsive/2.2.9/js/dataTables.responsive.min.js') }}">
    </script>
    <script src="{{ asset('main_template/assets/libs/cdn.datatables.net/buttons/2.2.2/js/dataTables.buttons.min.js') }}">
    </script>
    <script src="{{ asset('main_template/assets/libs/cdn.datatables.net/buttons/2.2.2/js/buttons.print.min.js') }}">
    </script>
    <script src="{{ asset('main_template/assets/libs/cdn.datatables.net/buttons/2.2.2/js/buttons.html5.min.js') }}">
    </script>
    <script
        src="{{ asset('main_template/assets/libs/cdn.datatables.net/fixedheader/js/dataTables.fixedColumns.min.js') }}">
    </script>
    <script src="{{ asset('main_template/assets/libs/cdn.datatables.net/fixedheader/js/dataTables.fixedHeader.min.js') }}">
    </script>
    <script src="{{ asset('main_template/assets/libs/cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.53/vfs_fonts.js') }}">
    </script>
    <script src="{{ asset('main_template/assets/libs/cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.53/pdfmake.min.js') }}">
    </script>
    <script src="{{ asset('main_template/assets/libs/cdnjs.cloudflare.com/ajax/libs/jszip/3.1.3/jszip.min.js') }}">
    </script>
    ...
    <script src="{{ asset('main_template/assets/libs/cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js') }}">
    </script>
