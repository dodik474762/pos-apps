@if (isset($akses->pengajuan_limit_top))
    @if ($akses->pengajuan_limit_top->view == 1)
        <input type="hidden" id="update" value="{{ $akses->pengajuan_limit_top->update }}">
        <input type="hidden" id="delete" value="{{ $akses->pengajuan_limit_top->delete }}">
                    ...
                    <div class="card-body pt-0">
                        <div>
                            <ul class="nav nav-tabs nav-tabs-custom nav-success mb-3" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link py-3" data-bs-toggle="tab" id="Approved"
                                        href="#list-data-history" role="tab" aria-selected="false">
                                        <i class="ri-file-list-fill me-1 align-bottom"></i> History {{ $title }}
                                    </a>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content">
                                        ...
                                        <table class="table table-nowrap align-middle" id="table-data-acc">
                                            <thead class="text-muted table-light">
                                                <tr class="text-uppercase">
                                                    ...
                                                    <th>Credit Limit Saat Ini</th>
                                                    <th>Pengajuan Credit Limit</th>
                                                    <th>TOP Saat Ini</th>
                                                    <th>Pengajuan TOP</th>
                                                    <th>Status</th>
                                                    <th>Spv Sales Acc</th>
                                ...
                                <div class="tab-pane" id="list-data-history">
                                    <div class="table-responsive table-card mb-1">
                                        <table class="table table-nowrap align-middle" id="table-data-history">
                                            <thead class="text-muted table-light">
                                                <tr class="text-uppercase">
                                                    <th>No</th>
                                                    <th>Code</th>
