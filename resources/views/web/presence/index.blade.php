@if (isset($akses->presensi))
    @if ($akses->presensi->view == 1)
        <input type="hidden" id="update" value="{{ $akses->presensi->update }}">
        <input type="hidden" id="delete" value="{{ $akses->presensi->delete }}">
