...
<head>
    ...
    <meta charset="utf-8" />
    <title>Reset Password | DPI</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="Sistem DPI" name="description" />
...
<body>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            ...
                            <p class="mt-3 fs-15 fw-medium">Change your password</p>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Reset password with input your new password</p>
                                ...
                                <div class="alert border-0 alert-warning text-center mb-2 mx-2" role="alert">
                                    Enter your password and the password automatically will be set to you!
                                </div>
                                <div class="p-2">
                                    @if (isset($error))
                                    ...
                                    @endif
                                    <form method="POST" action="{{ url('/user/submitNewPassword') }}">
                                        ...
                                        <div class="text-center mt-4">
                                            <button class="btn btn-success w-100" type="submit">Process</button>
                                            &nbsp;
                                            <a class="btn btn-primary w-100" href="{{ url('/dashboard') }}">Back to
                                                Dashboard</a>
                                        </div>
                                    </form><!-- end form -->
                                </div>
    ...
    <!-- particles js -->
    <script src="{{ asset('main_template/assets/libs/particles.js/particles.js') }}"></script>

    <!-- particles app js -->
    <script src="{{ asset('main_template/assets/js/pages/particles.app.js') }}"></script>
</body>
