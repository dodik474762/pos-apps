@if (isset($akses->karyawan))
    @if ($akses->karyawan->view == 1)
        <input type="hidden" id="update" value="{{ $akses->karyawan->update }}">
        <input type="hidden" id="delete" value="{{ $akses->karyawan->delete }}">
