...
@if (isset($akses->kecamatan))
    @if ($akses->kecamatan->view == 1)
        <input type="hidden" id="update" value="{{ $akses->kecamatan->update }}">
        <input type="hidden" id="delete" value="{{ $akses->kecamatan->delete }}">
