...
@if (isset($akses->adjustment_stock))
    @if ($akses->adjustment_stock->view == 1)
        <input type="hidden" id="update" value="{{ $akses->adjustment_stock->update }}">
        <input type="hidden" id="delete" value="{{ $akses->adjustment_stock->delete }}">
                    ...
                    <div class="card-header border-0">
                        <div class="row align-items-center gy-3">
                            ...
                            <div class="col-sm-auto">
                                @if ($akses->adjustment_stock->insert == 1)
                                    <div class="d-flex gap-1 flex-wrap">
                                        <a type="button" class="btn btn-success add-btn" data-bs-toggle="modal"
                                            id="create-btn" href="javascript:void(0);" onclick="AdjustmentStock.add(this, event)"><i
