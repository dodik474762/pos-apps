@if (isset($akses->accounting_periods))
    @if ($akses->accounting_periods->view == 1)
        <input type="hidden" id="update" value="{{ $akses->accounting_periods->update }}">
        <input type="hidden" id="delete" value="{{ $akses->accounting_periods->delete }}">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card" id="accountingPeriodsList">
                    <div class="card-header border-0">
                        <div class="row align-items-center gy-3">
                            ...
                            <div class="col-sm-auto">
                                @if ($akses->accounting_periods->insert == 1)
                                    <div class="d-flex gap-1 flex-wrap">
                                        <a type="button" class="btn btn-success add-btn" data-bs-toggle="modal"
                                            id="create-btn" href="javascript:void(0);"
                                            onclick="AccountingPeriods.add(this, event)">
                                            <i class="ri-add-line align-bottom me-1"></i> Create New
                                        </a>
                                        <button type="button" class="btn btn-primary"
                                            onclick="AccountingPeriods.generateYear(this, event)">
                                            <i class="ri-calendar-line align-bottom me-1"></i> Generate Year
                                        </button>
                                    </div>
                                @endif
                            </div>
                                ...
                                <div class="col-xxl-2 col-sm-4">
                                    <div>
                                        <input type="text" class="form-control" data-provider="flatpickr"
                                            data-date-format="d M, Y" id="search-datepicker"
