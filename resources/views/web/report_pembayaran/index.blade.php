...
@if (isset($akses->report_pembayaran))
    @if ($akses->report_pembayaran->view == 1)
        <input type="hidden" id="update" value="{{ $akses->report_pembayaran->update }}">
        <input type="hidden" id="delete" value="{{ $akses->report_pembayaran->delete }}">
                    ...
                    <div class="card-header border-0">
                        <div class="row align-items-center gy-3">
                            ...
                            <div class="col-sm-auto">
                                @if ($akses->report_pembayaran->insert == 1)
                                @endif
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-xxl-1 col-sm-4">
                                    <div>
                                        <button type="button" class="btn btn-primary w-100"
                                            onclick="ReportPembayaran.getData();"> <i
