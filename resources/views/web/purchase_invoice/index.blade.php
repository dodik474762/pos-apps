...
@if (isset($akses->purchase_invoice))
    @if ($akses->purchase_invoice->view == 1)
        <input type="hidden" id="update" value="{{ $akses->purchase_invoice->update }}">
        <input type="hidden" id="delete" value="{{ $akses->purchase_invoice->delete }}">
