@if (isset($akses->tax))
    @if ($akses->tax->view == 1)
        <input type="hidden" id="update" value="{{ $akses->tax->update }}">
        <input type="hidden" id="delete" value="{{ $akses->tax->delete }}">
