...
class KelurahanController extends Controller
{
    ...
    {
        return array(
            'js-1' => asset('assets/js/controllers/master/kelurahan.js'),
    ...
    public function index()
    {
        ...
        // echo '<pre>';
        // print_r($data);die;
        $view = view('web.kelurahan.index', $data);
    ...
    public function add()
    {
        ...
        $view = view('web.kelurahan.formadd', $data);
        $put['title_content'] = $this->getTitle();
    ...
    {
        $api = new MasterKelurahanController();
        $data = $request->all();
