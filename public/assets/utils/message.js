var message = {
    ...
    sweetSuccess: (title = "Informasi", message = "Data Berhasil Disimpan") => {
        Swal.fire({
            title: title,
            html: message,
            icon: "success",
    ...
    sweetError: (title = "Informasi", message = "Data Gagal Disimpan") => {
        Swal.fire({
            title: title,
            html: message,
            icon: "error",
    ...
    sweetInfo: (title = "Informasi", message = "Data Gagal Disimpan") => {
        Swal.fire({
            title: title,
            html: message,
            icon: "info",
