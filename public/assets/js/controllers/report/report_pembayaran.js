...
let latitude = 0.0;
let longitude = 0.0;
let ReportPembayaran = {
    module: () => {
        return "report/report_pembayaran";
    },

    moduleApi: () => {
        return "api/" + ReportPembayaran.module();
    },
    ...
    cancel: (elm, e) => {
        e.preventDefault();
        window.location.href = url.base_url(ReportPembayaran.module()) + "/";
    },

    add: (elm, e) => {
        e.preventDefault();
        window.location.href = url.base_url(ReportPembayaran.module()) + "add";
    },
    ...
    submit: (elm, e) => {
        ...
        if (validation.runWithElement(form)) {
            let params = ReportPembayaran.getPostInput();
            $.ajax({
                type: "POST",
                dataType: "json",
                data: params,
                headers: {
                    "X-CSRF-TOKEN": ReportPembayaran.csrf_token(),
                },
                url: url.base_url(ReportPembayaran.moduleApi()) + "submit",
                beforeSend: () => {
    ...
    submitMom: (elm, e) => {
        e.preventDefault();
        let params = ReportPembayaran.getPostInputMom();
        ...
        $.ajax({
            ...
            dataType: "json",
            data: params,
            url: url.base_url(ReportPembayaran.moduleApi()) + "submitMom",
            beforeSend: () => {
                message.loadingProses("Proses Simpan Data...");
            },
            error: function () {
    ...
    getData: async () => {
        ...
        var data = tableData.DataTable({
            ...
            ajax: {
                url: url.base_url(ReportPembayaran.moduleApi()) + `getData`,
                type: "POST",
                headers: {
                    "X-CSRF-TOKEN": ReportPembayaran.csrf_token(),
                },
    ...
    delete: (elm, e) => {
        ...
        $.ajax({
            ...
            url: url.base_url(ReportPembayaran.moduleApi()) + "delete",
            beforeSend: () => {
    ...
    confirmDelete: (elm) => {
        ...
        $.ajax({
            ...
            url: url.base_url(ReportPembayaran.moduleApi()) + "confirmDelete",
            beforeSend: () => {
                message.loadingProses("Proses Simpan Data...");
            },
            error: function () {
    ...
    showDataKaryawan: (elm) => {
        ...
        $.ajax({
            ...
            url: url.base_url(ReportPembayaran.moduleApi()) + "showDataKaryawan",
            ...
            success: function (resp) {
                ...
                ReportPembayaran.getDataKaryawan();
            },
        });
    },
    ...
    showDataCompany: (elm) => {
        ...
        $.ajax({
            ...
            url: url.base_url(ReportPembayaran.moduleApi()) + "showDataCompany",
            ...
            success: function (resp) {
                ...
                $("#content-modal-form").html(resp);
                $("#btn-show-modal").trigger("click");
                ReportPembayaran.getDataCompany();
            },
        });
    },
    ...
    showDataCustomer: (elm) => {
        ...
        $.ajax({
            ...
            url: url.base_url(ReportPembayaran.moduleApi()) + "showDataCustomer",
            ...
            success: function (resp) {
                ...
                $("#content-modal-form").html(resp);
                $("#btn-show-modal").trigger("click");
                ReportPembayaran.getDataCustomer();
            },
        });
    },
    ...
    showDataVendor: (elm) => {
        ...
        $.ajax({
            ...
            url: url.base_url(ReportPembayaran.moduleApi()) + "showDataVendor",
            ...
            success: function (resp) {
                ...
                $("#btn-show-modal").trigger("click");
                objInput = elm;
                ReportPembayaran.getDataVendor();
            },
        });
    },
    ...
    showDataForecast: (elm) => {
        ...
        $.ajax({
            ...
            url: url.base_url(ReportPembayaran.moduleApi()) + "showDataForecast",
            ...
            success: function (resp) {
                ...
                $("#content-modal-form").html(resp);
                $("#btn-show-modal").trigger("click");
                ReportPembayaran.getDataForecast();
            },
        });
    },
    ...
    getDataKaryawan: () => {
        ...
        var data = tableData.DataTable({
            ...
            ajax: {
                url:
                    url.base_url(ReportPembayaran.moduleApiKaryawan()) + `getData`,
                type: "POST",
                headers: {
                    "X-CSRF-TOKEN": ReportPembayaran.csrf_token(),
                },
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        var html = "";
                        html += `<a href='' nama_lengkap="${row.nama_lengkap}" onclick="ReportPembayaran.pilihData(this, event)" data_id="${row.id}" class="btn btn-info editable-submit btn-sm waves-effect waves-light"><i class="bx bx-edit"></i></a>&nbsp;`;
                        return html;
                    },
                },
            ],
    ...
    getDataForecast: () => {
        ...
        var data = tableData.DataTable({
            ...
            ajax: {
                url: url.base_url(ReportPembayaran.moduleApiProject()) + `getData`,
                type: "POST",
                data: {
                    type: "project",
                },
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        var html = "";
                        html += `<a href='' data_id="${row.id}" code="${row.code_project}" onclick="ReportPembayaran.pilihDataForecast(this, event)" data_id="${row.nik}" class="btn btn-info editable-submit btn-sm waves-effect waves-light"><i class="bx bx-edit"></i></a>&nbsp;`;
                        return html;
                    },
                },
            ],
    ...
    getDataVendor: () => {
        ...
        var data = tableData.DataTable({
            ...
            ajax: {
                url: url.base_url(ReportPembayaran.moduleApiVendor()) + `getData`,
                type: "POST",
            },
            deferRender: true,
            createdRow: function (row, data, dataIndex) {
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        var html = "";
                        html += `<a href='' data_id="${row.id}" nama_vendor="${row.nama_vendor}" onclick="ReportPembayaran.pilihDataVendor(this, event)" data_id="${row.nik}" class="btn btn-info editable-submit btn-sm waves-effect waves-light"><i class="bx bx-edit"></i></a>&nbsp;`;
                        return html;
                    },
                },
            ],
    ...
    getDataCompany: () => {
        ...
        var data = tableData.DataTable({
            ...
            ajax: {
                url: url.base_url(ReportPembayaran.moduleApiCompany()) + `getData`,
                type: "POST",
            },
            deferRender: true,
            createdRow: function (row, data, dataIndex) {
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        var html = "";
                        html += `<a href='' data_id="${row.id}" nama_company="${row.nama_company}" onclick="ReportPembayaran.pilihDataCompany(this, event)" class="btn btn-info editable-submit btn-sm waves-effect waves-light"><i class="bx bx-edit"></i></a>&nbsp;`;
                        return html;
                    },
                },
            ],
    ...
    getDataCustomer: () => {
        ...
        var data = tableData.DataTable({
            ...
            ajax: {
                url:
                    url.base_url(ReportPembayaran.moduleApiCustomer()) + `getData`,
                type: "POST",
            },
            deferRender: true,
            createdRow: function (row, data, dataIndex) {
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        var html = "";
                        html += `<a href='' data_id="${row.id}" nama_customer="${row.nama_customer}" onclick="ReportPembayaran.pilihDataCustomer(this, event)" class="btn btn-info editable-submit btn-sm waves-effect waves-light"><i class="bx bx-edit"></i></a>&nbsp;`;
                        return html;
                    },
                },
            ],
    ...
    pilihDataForecast: (elm, e) => {
        ...
        ReportPembayaran.getDetailForecast(dataId);
    },
    ...
    getDetailForecast: (id) => {
        $.ajax({
            ...
            url:
                url.base_url(ReportPembayaran.moduleApiForecast()) +
                "getDetailForecast",
            beforeSend: () => {
                message.loadingProses("Proses Pengambilan Data...");
            },
    ...
    getCity: (elm) => {
        ...
        $.ajax({
            ...
            url: url.base_url(ReportPembayaran.moduleApiForecast()) + "getCity",
            beforeSend: () => {
                message.loadingProses("Proses Pengambilan Data...");
            },
            error: function () {
    ...
    addItem: (elm, e) => {
        ...
        newTr
            .find("td#action")
            .html(
                `<button type="button" onclick="ReportPembayaran.deleteItem(this, event)" class="btn btn-danger editable-cancel btn-sm waves-effect waves-light"><i class="bx bx-trash-alt"></i></button>`,
            );
        table.after(newTr);
    },
    ...
    getDataSummary: async () => {
        ...
        var data = tableData.DataTable({
            ...
            ajax: {
                url: url.base_url(ReportPembayaran.moduleApi()) + `getDataSummary`,
                type: "POST",
                headers: {
                    "X-CSRF-TOKEN": ReportPembayaran.csrf_token(),
                },
            ...
            buttons: [
                {
                    extend: "excel",
                    filename: "ReportPembayaran_Summary",
                    action: newexportaction,
                },
            ],
            columns: [
...
$(function () {
    ReportPembayaran.setSelect2();
    ReportPembayaran.getData();
});
