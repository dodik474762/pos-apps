...
let ReportPiutang = {
    module: () => {
        return "report/report_piutang";
    },

    moduleApi: () => {
        return "api/" + ReportPiutang.module();
    },
    ...
    cancel: (elm, e) => {
        e.preventDefault();
        window.location.href = url.base_url(ReportPiutang.module()) + "/";
    },

    add: (elm, e) => {
        e.preventDefault();
        window.location.href = url.base_url(ReportPiutang.module()) + "add";
    },
    ...
    submit: (elm, e) => {
        ...
        if (validation.runWithElement(form)) {
            let params = ReportPiutang.getPostInput();
            $.ajax({
                type: "POST",
                dataType: "json",
                data: params,
                headers: {
                    "X-CSRF-TOKEN": ReportPiutang.csrf_token(),
                },
                url: url.base_url(ReportPiutang.moduleApi()) + "submit",
                beforeSend: () => {
    ...
    submitMom: (elm, e) => {
        e.preventDefault();
        let params = ReportPiutang.getPostInputMom();
        ...
        $.ajax({
            ...
            dataType: "json",
            data: params,
            url: url.base_url(ReportPiutang.moduleApi()) + "submitMom",
            beforeSend: () => {
                message.loadingProses("Proses Simpan Data...");
            },
            error: function () {
    ...
    getData: async () => {
        ...
        var data = tableData.DataTable({
            ...
            ajax: {
                url: url.base_url(ReportPiutang.moduleApi()) + `getData`,
                type: "POST",
                headers: {
                    "X-CSRF-TOKEN": ReportPiutang.csrf_token(),
                },
    ...
    delete: (elm, e) => {
        ...
        $.ajax({
            ...
            url: url.base_url(ReportPiutang.moduleApi()) + "delete",
            beforeSend: () => {
    ...
    confirmDelete: (elm) => {
        ...
        $.ajax({
            ...
            url: url.base_url(ReportPiutang.moduleApi()) + "confirmDelete",
            beforeSend: () => {
                message.loadingProses("Proses Simpan Data...");
            },
            error: function () {
    ...
    showDataKaryawan: (elm) => {
        ...
        $.ajax({
            ...
            url: url.base_url(ReportPiutang.moduleApi()) + "showDataKaryawan",
    ...
    showDataCompany: (elm) => {
        ...
        $.ajax({
            ...
            url: url.base_url(ReportPiutang.moduleApi()) + "showDataCompany",
    ...
    showDataCustomer: (elm) => {
        ...
        $.ajax({
            ...
            url: url.base_url(ReportPiutang.moduleApi()) + "showDataCustomer",
    ...
    showDataVendor: (elm) => {
        ...
        $.ajax({
            ...
            url: url.base_url(ReportPiutang.moduleApi()) + "showDataVendor",
    ...
    showDataForecast: (elm) => {
        ...
        $.ajax({
            ...
            url: url.base_url(ReportPiutang.moduleApi()) + "showDataForecast",
    ...
    getDataKaryawan: () => {
        ...
        var data = tableData.DataTable({
            ...
            ajax: {
                url:
                    url.base_url(ReportPiutang.moduleApiKaryawan()) + `getData`,
                type: "POST",
                headers: {
                    "X-CSRF-TOKEN": ReportPiutang.csrf_token(),
                },
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        var html = "";
                        html += `<a href='' nama_lengkap="${row.nama_lengkap}" onclick="ReportPiutang.pilihData(this, event)" data_id="${row.id}" class="btn btn-info editable-submit btn-sm waves-effect waves-light"><i class="bx bx-edit"></i></a>&nbsp;`;
                        return html;
                    },
                },
            ],
    ...
    getDataForecast: () => {
        ...
        var data = tableData.DataTable({
            ...
            ajax: {
                url: url.base_url(ReportPiutang.moduleApiProject()) + `getData`,
                type: "POST",
                data: {
                    type: "project",
                },
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        var html = "";
                        html += `<a href='' data_id="${row.id}" code="${row.code_project}" onclick="ReportPiutang.pilihDataForecast(this, event)" data_id="${row.nik}" class="btn btn-info editable-submit btn-sm waves-effect waves-light"><i class="bx bx-edit"></i></a>&nbsp;`;
                        return html;
                    },
                },
            ],
    ...
    getDataVendor: () => {
        ...
        var data = tableData.DataTable({
            ...
            ajax: {
                url: url.base_url(ReportPiutang.moduleApiVendor()) + `getData`,
                type: "POST",
            },
            deferRender: true,
            createdRow: function (row, data, dataIndex) {
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        var html = "";
                        html += `<a href='' data_id="${row.id}" nama_vendor="${row.nama_vendor}" onclick="ReportPiutang.pilihDataVendor(this, event)" data_id="${row.nik}" class="btn btn-info editable-submit btn-sm waves-effect waves-light"><i class="bx bx-edit"></i></a>&nbsp;`;
                        return html;
                    },
                },
            ],
    ...
    getDataCompany: () => {
        ...
        var data = tableData.DataTable({
            ...
            ajax: {
                url: url.base_url(ReportPiutang.moduleApiCompany()) + `getData`,
                type: "POST",
            },
            deferRender: true,
            createdRow: function (row, data, dataIndex) {
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        var html = "";
                        html += `<a href='' data_id="${row.id}" nama_company="${row.nama_company}" onclick="ReportPiutang.pilihDataCompany(this, event)" class="btn btn-info editable-submit btn-sm waves-effect waves-light"><i class="bx bx-edit"></i></a>&nbsp;`;
                        return html;
                    },
                },
            ],
    ...
    getDataCustomer: () => {
        ...
        var data = tableData.DataTable({
            ...
            ajax: {
                url:
                    url.base_url(ReportPiutang.moduleApiCustomer()) + `getData`,
                type: "POST",
            },
            deferRender: true,
            createdRow: function (row, data, dataIndex) {
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        var html = "";
                        html += `<a href='' data_id="${row.id}" nama_customer="${row.nama_customer}" onclick="ReportPiutang.pilihDataCustomer(this, event)" class="btn btn-info editable-submit btn-sm waves-effect waves-light"><i class="bx bx-edit"></i></a>&nbsp;`;
                        return html;
                    },
                },
            ],
    ...
    pilihDataForecast: (elm, e) => {
        ...
        ReportPiutang.getDetailForecast(dataId);
    },
    ...
    getDetailForecast: (id) => {
        $.ajax({
            ...
            url:
                url.base_url(ReportPiutang.moduleApiForecast()) +
                "getDetailForecast",
            beforeSend: () => {
                message.loadingProses("Proses Pengambilan Data...");
            },
    ...
    getCity: (elm) => {
        ...
        $.ajax({
            ...
            url: url.base_url(ReportPiutang.moduleApiForecast()) + "getCity",
            beforeSend: () => {
                message.loadingProses("Proses Pengambilan Data...");
            },
            error: function () {
    ...
    addItem: (elm, e) => {
        ...
        newTr
            .find("td#action")
            .html(
                `<button type="button" onclick="ReportPiutang.deleteItem(this, event)" class="btn btn-danger editable-cancel btn-sm waves-effect waves-light"><i class="bx bx-trash-alt"></i></button>`,
            );
        table.after(newTr);
    },
    ...
    getDataSummary: async () => {
        ...
        var data = tableData.DataTable({
            ...
            ajax: {
                url: url.base_url(ReportPiutang.moduleApi()) + `getDataSummary`,
                type: "POST",
                headers: {
                    "X-CSRF-TOKEN": ReportPiutang.csrf_token(),
                },
            ...
            buttons: [
                {
                    extend: "excel",
                    filename: "ReportPiutang_Summary",
                    action: newexportaction,
                },
            ],
            columns: [
...
$(function () {
    ReportPiutang.setSelect2();
    ReportPiutang.getData();
});
