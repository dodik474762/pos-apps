...
let SalesPlan = {
    ...
    cancel: (elm, e) => {
        e.preventDefault();
        window.location.href = url.base_url(SalesPlan.module()) + "/";
    },
    ...
    submit: (elm, e) => {
        ...
        if (validation.runWithElement(form)) {
            let params = SalesPlan.getPostInput();
            $.ajax({
                type: "POST",
                dataType: "json",
                data: params,
                url: url.base_url(SalesPlan.moduleApi()) + "submit",
                headers: {
    ...
    getData: async () => {
        ...
        var data = tableData.DataTable({
            ...
            ajax: {
                url: url.base_url(SalesPlan.moduleApi()) + `getData`,
                type: "POST",
                headers: {
                    "X-CSRF-TOKEN": SalesPlan.csrf_token(),
                },
    ...
    delete: (elm, e) => {
        ...
        $.ajax({
            ...
            dataType: "html",
            data: params,
            url: url.base_url(SalesPlan.moduleApi()) + "delete",
            headers: {
                "X-CSRF-TOKEN": SalesPlan.csrf_token(),
            },
            beforeSend: () => {
    ...
    confirmDelete: (elm) => {
        ...
        $.ajax({
            ...
            dataType: "json",
            data: params,
            url: url.base_url(SalesPlan.moduleApi()) + "confirmDelete",
            headers: {
                "X-CSRF-TOKEN": SalesPlan.csrf_token(),
            },
            beforeSend: () => {
    ...
    showDataProduct: (elm) => {
        ...
        $.ajax({
            ...
            dataType: "html",
            data: params,
            url: url.base_url(SalesPlan.moduleApi()) + "showDataProduct",
            headers: {
                "X-CSRF-TOKEN": SalesPlan.csrf_token(),
            },
    ...
    getDataProduct: () => {
        ...
        var data = tableData.DataTable({
            ...
            ajax: {
                url: url.base_url(SalesPlan.moduleApi()) + `getDataProduct`,
                type: "POST",
                headers: {
                    "X-CSRF-TOKEN": SalesPlan.csrf_token(),
                },
    ...
    calcDiscRow: (elm) => {
        ...
        const UOM_CONVERSION = SalesPlan.getDataUomConversion();
        const DATA_DISKON = SalesPlan.getDataDiskon();
        const DATA_DISKON_FREE = SalesPlan.getDataDiskonFreeGood();

        // Konversi qty input ke satuan terkecil
        const qtySmallest = SalesPlan.convertToSmallest(
            UOM_CONVERSION,
            productId,
            satuanId,
            qty
        ...
        const applicable = DATA_DISKON.find((d) => {
            ...
            const minSmall = SalesPlan.convertToSmallest(
                UOM_CONVERSION,
                d.product_id,
                d.unit_id,
                d.min_qty
            ...
            if (!exists) {
                const freeRow = `
                    <tr class="input freegood" data-free-for="${productId}">
                        ...
                        <td class="text-center"><button type="button" class="btn btn-sm btn-danger" disabled onclick="SalesPlan.removeRow(this)"><i class="bx bx-gift"></i></button></td>
                    </tr>
                `;
