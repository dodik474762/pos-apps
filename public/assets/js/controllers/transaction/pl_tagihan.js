...
let PLTagihan = {
    ...
    cancel: (elm, e) => {
        e.preventDefault();
        window.location.href = url.base_url(PLTagihan.module()) + "/";
    },

    add: (elm, e) => {
        e.preventDefault();
        window.location.href = url.base_url(PLTagihan.module()) + "add";
    },
    ...
    getData: async () => {
        ...
        var data = tableData.DataTable({
            ...
            ajax: {
                url: url.base_url(PLTagihan.moduleApi()) + `getData`,
                type: "POST",
                headers: {
                    "X-CSRF-TOKEN": PLTagihan.csrf_token(),
                },
    ...
    delete: (elm, e) => {
        ...
        $.ajax({
            ...
            dataType: "html",
            data: params,
            url: url.base_url(PLTagihan.moduleApi()) + "delete",
            headers: {
                "X-CSRF-TOKEN": PLTagihan.csrf_token(),
            },
            beforeSend: () => {
    ...
    confirmDelete: (elm) => {
        ...
        $.ajax({
            ...
            dataType: "json",
            data: params,
            url: url.base_url(PLTagihan.moduleApi()) + "confirmDelete",
            headers: {
                "X-CSRF-TOKEN": PLTagihan.csrf_token(),
            },
            beforeSend: () => {
    ...
    showModalDO: (elm) => {
        ...
        $.ajax({
            ...
            dataType: "html",
            data: params,
            url: url.base_url(PLTagihan.moduleApi()) + "showModalDO",
            headers: {
                "X-CSRF-TOKEN": PLTagihan.csrf_token(),
            },
    ...
    getDataDo: () => {
        ...
        var data = tableData.DataTable({
            ...
            ajax: {
                url: url.base_url(PLTagihan.moduleApi()) + `getDataDo`,
                type: "POST",
                headers: {
                    "X-CSRF-TOKEN": PLTagihan.csrf_token(),
                },
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        onclick="PLTagihan.pilihDataDo(this, event)"
    ...
    getDoDetail: (do_id) => {
        ...
        $.ajax({
            ...
            dataType: "html",
            data: params,
            url: url.base_url(PLTagihan.moduleApi()) + "getDoDetail",
            headers: {
                "X-CSRF-TOKEN": PLTagihan.csrf_token(),
            },
    ...
    calcDiscRow: (elm) => {
        ...
        const UOM_CONVERSION = PLTagihan.getDataUomConversion();
        const DATA_DISKON = PLTagihan.getDataDiskon();
        const DATA_DISKON_FREE = PLTagihan.getDataDiskonFreeGood();

        // Konversi qty input ke satuan terkecil
        const qtySmallest = PLTagihan.convertToSmallest(
            UOM_CONVERSION,
            productId,
            satuanId,
            qty
        ...
        const applicable = DATA_DISKON.find((d) => {
            ...
            const minSmall = PLTagihan.convertToSmallest(
                UOM_CONVERSION,
                d.product_id,
                d.unit_id,
                d.min_qty
            );
            const maxSmall = PLTagihan.convertToSmallest(
                UOM_CONVERSION,
                d.product_id,
                d.unit_id,
                d.max_qty
            ...
            if (!exists) {
                const freeRow = `
                    ...
                    "Free Product"
                        ...
                        <td class="text-center"><button type="button" class="btn btn-sm btn-danger" disabled onclick="PLTagihan.removeRow(this)"><i class="bx bx-gift"></i></button></td>
                    </tr>
                `;
    ...
    editReload: () => {
        ...
        if (id != "") {
            ...
            resultProduct.forEach((item) => {
                ...
                PLTagihan.showDiscountProduct(
                    [product_id],
                    [product_name],
                    [unit_id]
                );
                PLTagihan.showDiscountFreeProduct(
                    [product_id],
                    [product_name],
                    [unit_id]
                );
                PLTagihan.showQtySmallestProduct(
                    [product_id],
                    [product_name],
                    [unit_id]
                );
