...
let GoodReceipt = {
    ...
    cancel: (elm, e) => {
        e.preventDefault();
        window.location.href = url.base_url(GoodReceipt.module()) + "/";
    },

    add: (elm, e) => {
        e.preventDefault();
        window.location.href = url.base_url(GoodReceipt.module()) + "add";
    },
    ...
    submit: (elm, e) => {
        ...
        if (validation.runWithElement(form)) {
            let params = GoodReceipt.getPostInput();
            $.ajax({
                type: "POST",
                dataType: "json",
                data: params,
                url: url.base_url(GoodReceipt.moduleApi()) + "submit",
                headers: {
                    "X-CSRF-TOKEN": GoodReceipt.csrf_token(),
                },
                beforeSend: () => {
    ...
    getData: async () => {
        ...
        var data = tableData.DataTable({
            ...
            ajax: {
                url: url.base_url(GoodReceipt.moduleApi()) + `getData`,
                type: "POST",
                headers: {
                    "X-CSRF-TOKEN": GoodReceipt.csrf_token(),
                },
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        if (row.status == 'open'){
                            html += `<button type="button" data_id="${row.id}" onclick="GoodReceipt.postJurnal(this, event)" class="btn btn-warning editable-post btn-sm waves-effect waves-light" title="Buat Jurnal Penerimaan"><i class="bx bx-book-alt"></i></button>&nbsp;`;
                        }
                        if (deleteAction == 1) {
                            if(row.status == 'open'){
    ...
    delete: (elm, e) => {
        ...
        $.ajax({
            ...
            dataType: "html",
            data: params,
            url: url.base_url(GoodReceipt.moduleApi()) + "delete",
            headers: {
                "X-CSRF-TOKEN": GoodReceipt.csrf_token(),
            },
            beforeSend: () => {
    ...
    confirmDelete: (elm) => {
        ...
        $.ajax({
            ...
            dataType: "json",
            data: params,
            url: url.base_url(GoodReceipt.moduleApi()) + "confirmDelete",
            headers: {
                "X-CSRF-TOKEN": GoodReceipt.csrf_token(),
            },
            beforeSend: () => {
    ...
    postJurnal: (elm, e) => {
        ...
        $.ajax({
            ...
            dataType: "html",
            data: params,
            url: url.base_url(GoodReceipt.moduleApi()) + "showModalPostJurnal",
            headers: {
                "X-CSRF-TOKEN": GoodReceipt.csrf_token(),
            },
            beforeSend: () => {
    ...
    confirmPostJurnal: (elm) => {
        ...
        $.ajax({
            ...
            dataType: "json",
            data: params,
            url: url.base_url(GoodReceipt.moduleApi()) + "postJurnal",
            headers: {
                "X-CSRF-TOKEN": GoodReceipt.csrf_token(),
            },
            beforeSend: () => {
    ...
    showDataPOItem: (elm) => {
        ...
        $.ajax({
            ...
            dataType: "html",
            data: params,
            url: url.base_url(GoodReceipt.moduleApi()) + "showDataPOItem",
            headers: {
                "X-CSRF-TOKEN": GoodReceipt.csrf_token(),
            },
    ...
    getListItemOutstandingPO: (elm) => {
        ...
        $.ajax({
            ...
            dataType: "html",
            data: params,
            url: url.base_url(GoodReceipt.moduleApi()) + "getListItemOutstandingPO",
            headers: {
                "X-CSRF-TOKEN": GoodReceipt.csrf_token(),
            },
    ...
    getDataProduct: (po) => {
        ...
        var data = tableData.DataTable({
            ...
            ajax: {
                url:
                    url.base_url(GoodReceipt.moduleApiPo()) +
                    `getDataProduct`,
                type: "POST",
                data: {
                    po: po
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        onclick="GoodReceipt.pilihDataProduct(this, event)"
