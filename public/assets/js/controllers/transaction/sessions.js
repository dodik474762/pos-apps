...
let Sessions = {
    module: () => {
        return "transaksi/sessions";
    },

    moduleApi: () => {
        return "api/" + Sessions.module();
    },
    ...
    cancel: (elm, e) => {
        e.preventDefault();
        window.location.href = url.base_url(Sessions.module()) + "/";
    },

    add: (elm, e) => {
        e.preventDefault();
        window.location.href = url.base_url(Sessions.module()) + "add";
    },
    ...
    submit: (elm, e) => {
        ...
        if (validation.runWithElement(form)) {
            let params = Sessions.getPostInput();
            $.ajax({
                type: "POST",
                dataType: "json",
                data: params,
                headers: {
                    "X-CSRF-TOKEN": Sessions.csrf_token(),
                },
                url: url.base_url(Sessions.moduleApi()) + "submit",
                beforeSend: () => {
    ...
    submitMom: (elm, e) => {
        e.preventDefault();
        let params = Sessions.getPostInputMom();
        ...
        $.ajax({
            ...
            dataType: "json",
            data: params,
            url: url.base_url(Sessions.moduleApi()) + "submitMom",
            beforeSend: () => {
                message.loadingProses("Proses Simpan Data...");
            },
            error: function () {
    ...
    getData: async () => {
        ...
        var data = tableData.DataTable({
            ...
            ajax: {
                url: url.base_url(Sessions.moduleApi()) + `getData`,
                type: "POST",
                headers: {
                    "X-CSRF-TOKEN": Sessions.csrf_token(),
                },
    ...
    delete: (elm, e) => {
        ...
        $.ajax({
            ...
            url: url.base_url(Sessions.moduleApi()) + "delete",
            beforeSend: () => {
    ...
    confirmDelete: (elm) => {
        ...
        $.ajax({
            ...
            url: url.base_url(Sessions.moduleApi()) + "confirmDelete",
            beforeSend: () => {
                message.loadingProses("Proses Simpan Data...");
            },
            error: function () {
    ...
    showDataKaryawan: (elm) => {
        ...
        $.ajax({
            ...
            url: url.base_url(Sessions.moduleApi()) + "showDataKaryawan",
    ...
    showDataCompany: (elm) => {
        ...
        $.ajax({
            ...
            url: url.base_url(Sessions.moduleApi()) + "showDataCompany",
    ...
    showDataCustomer: (elm) => {
        ...
        $.ajax({
            ...
            url: url.base_url(Sessions.moduleApi()) + "showDataCustomer",
    ...
    showDataVendor: (elm) => {
        ...
        $.ajax({
            ...
            url: url.base_url(Sessions.moduleApi()) + "showDataVendor",
    ...
    showDataForecast: (elm) => {
        ...
        $.ajax({
            ...
            url: url.base_url(Sessions.moduleApi()) + "showDataForecast",
    ...
    getDataKaryawan: () => {
        ...
        var data = tableData.DataTable({
            ...
            ajax: {
                url: url.base_url(Sessions.moduleApiKaryawan()) + `getData`,
                type: "POST",
                headers: {
                    "X-CSRF-TOKEN": Sessions.csrf_token(),
                },
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        var html = "";
                        html += `<a href='' nama_lengkap="${row.nama_lengkap}" onclick="Sessions.pilihData(this, event)" data_id="${row.id}" class="btn btn-info editable-submit btn-sm waves-effect waves-light"><i class="bx bx-edit"></i></a>&nbsp;`;
                        return html;
                    },
                },
            ],
    ...
    getDataForecast: () => {
        ...
        var data = tableData.DataTable({
            ...
            ajax: {
                url: url.base_url(Sessions.moduleApiProject()) + `getData`,
                type: "POST",
                data: {
                    type: "project",
                },
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        var html = "";
                        html += `<a href='' data_id="${row.id}" code="${row.code_project}" onclick="Sessions.pilihDataForecast(this, event)" data_id="${row.nik}" class="btn btn-info editable-submit btn-sm waves-effect waves-light"><i class="bx bx-edit"></i></a>&nbsp;`;
                        return html;
                    },
                },
            ],
    ...
    getDataVendor: () => {
        ...
        var data = tableData.DataTable({
            ...
            ajax: {
                url: url.base_url(Sessions.moduleApiVendor()) + `getData`,
                type: "POST",
            },
            deferRender: true,
            createdRow: function (row, data, dataIndex) {
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        var html = "";
                        html += `<a href='' data_id="${row.id}" nama_vendor="${row.nama_vendor}" onclick="Sessions.pilihDataVendor(this, event)" data_id="${row.nik}" class="btn btn-info editable-submit btn-sm waves-effect waves-light"><i class="bx bx-edit"></i></a>&nbsp;`;
                        return html;
                    },
                },
            ],
    ...
    getDataCompany: () => {
        ...
        var data = tableData.DataTable({
            ...
            ajax: {
                url: url.base_url(Sessions.moduleApiCompany()) + `getData`,
                type: "POST",
            },
            deferRender: true,
            createdRow: function (row, data, dataIndex) {
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        var html = "";
                        html += `<a href='' data_id="${row.id}" nama_company="${row.nama_company}" onclick="Sessions.pilihDataCompany(this, event)" class="btn btn-info editable-submit btn-sm waves-effect waves-light"><i class="bx bx-edit"></i></a>&nbsp;`;
                        return html;
                    },
                },
            ],
    ...
    getDataCustomer: () => {
        ...
        var data = tableData.DataTable({
            ...
            ajax: {
                url: url.base_url(Sessions.moduleApiCustomer()) + `getData`,
                type: "POST",
            },
            deferRender: true,
            createdRow: function (row, data, dataIndex) {
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        var html = "";
                        html += `<a href='' data_id="${row.id}" nama_customer="${row.nama_customer}" onclick="Sessions.pilihDataCustomer(this, event)" class="btn btn-info editable-submit btn-sm waves-effect waves-light"><i class="bx bx-edit"></i></a>&nbsp;`;
                        return html;
                    },
                },
            ],
    ...
    pilihDataForecast: (elm, e) => {
        ...
        Sessions.getDetailForecast(dataId);
    },
    ...
    getDetailForecast: (id) => {
        $.ajax({
            ...
            url:
                url.base_url(Sessions.moduleApiForecast()) +
                "getDetailForecast",
            beforeSend: () => {
                message.loadingProses("Proses Pengambilan Data...");
            },
    ...
    getCity: (elm) => {
        ...
        $.ajax({
            ...
            url: url.base_url(Sessions.moduleApiForecast()) + "getCity",
            beforeSend: () => {
                message.loadingProses("Proses Pengambilan Data...");
            },
            error: function () {
    ...
    addItem: (elm, e) => {
        ...
        newTr
            .find("td#action")
            .html(
                `<button type="button" onclick="Sessions.deleteItem(this, event)" class="btn btn-danger editable-cancel btn-sm waves-effect waves-light"><i class="bx bx-trash-alt"></i></button>`
            );
        table.after(newTr);
    },
