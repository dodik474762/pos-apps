...
let SalesPayment = {
    ...
    getData: async () => {
        ...
        var data = tableData.DataTable({
            ...
            buttons: [
                {
                    extend: "excel",
                    filename: "ReportSalesPaymentAll",
    ...
    getDataPending: async () => {
        ...
        var data = tableData.DataTable({
            ...
            buttons: [
                {
                    extend: "excel",
                    filename: "ReportSalesPaymentPending",
                    action: newexportaction,
                },
            ],
            columns: [
    ...
    getDataPosted: async () => {
        let tableData = $("table#table-data-posted");
        ...
        var data = tableData.DataTable({
            ...
            buttons: [
                {
                    extend: "excel",
                    filename: "ReportSalesPaymentPosted",
                    action: newexportaction,
                },
            ],
            columns: [
    ...
    getDataWaiting: async () => {
        let tableData = $("table#table-data-waiting");
        ...
        var data = tableData.DataTable({
            ...
            buttons: [
                {
                    extend: "excel",
                    filename: "ReportSalesPaymentWaiting",
                    action: newexportaction,
                },
            ],
            columns: [
...
$(function () {
    ...
    SalesPayment.getDataPosted();
    SalesPayment.getDataWaiting();
