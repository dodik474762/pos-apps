let WorkingHour = {
    ...
    cancel: (elm, e) => {
        e.preventDefault();
        window.location.href = url.base_url(WorkingHour.module()) + "/";
    },

    add: (elm, e) => {
        e.preventDefault();
        window.location.href = url.base_url(WorkingHour.module()) + "add";
    },
    ...
    submit: (elm, e) => {
        ...
        if (validation.runWithElement(form)) {
            let params = WorkingHour.getPostInput();
            $.ajax({
                type: "POST",
                dataType: "json",
                data: params,
                    ...
                    render: function (data, type, row) {
                        ...
                        if (deleteAction == 1) {
                            ...
                            <a class="text-danger d-inline-block remove-item-btn"
                                data-bs-toggle="modal" data_id="${row.id}" href="javascript:void(0);" onclick="WorkingHour.delete(this, event)">
