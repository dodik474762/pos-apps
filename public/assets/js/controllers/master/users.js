let Users = {
    ...
    cancel: (elm, e) => {
        e.preventDefault();
        window.location.href = url.base_url(Users.module()) + "/";
    },

    add: (elm, e) => {
        e.preventDefault();
        window.location.href = url.base_url(Users.module()) + "add";
    },
    ...
    submit: (elm, e) => {
        ...
        if (validation.runWithElement(form)) {
            let params = Users.getPostInput();
            $.ajax({
                type: "POST",
                dataType: "json",
                data: params,
                headers: {
                    "X-CSRF-TOKEN": Users.csrf_token(),
                },
    ...
    confirmDelete: (elm) => {
        ...
        $.ajax({
            ...
            dataType: "json",
            data: params,
            url: url.base_url(Users.moduleApi()) + "confirmDelete",
            headers: {
                "X-CSRF-TOKEN": Users.csrf_token(),
            },
            beforeSend: () => {
    ...
    getDataKaryawan: () => {
        ...
        var data = tableData.DataTable({
            ...
            ajax: {
                url: url.base_url(Users.moduleApiKaryawan()) + `getData`,
                type: "POST",
                headers: {
                    "X-CSRF-TOKEN": Users.csrf_token(),
                },
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        var html = "";
                        html += `<a href='' nama_lengkap="${row.nama_lengkap}" onclick="Users.pilihData(this, event)" data_id="${row.nik}" class="btn btn-info editable-submit btn-sm waves-effect waves-light"><i class="bx bx-edit"></i></a>&nbsp;`;
                        return html;
                    },
                },
            ],
