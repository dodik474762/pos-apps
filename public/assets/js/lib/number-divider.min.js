!(function (i) {
    var e = { delimiter: ",", divideThousand: !0, delimiterRegExp: /[\.\,\s]/g },
        n = i.fn.val;
    (i.fn.val = function (i) {
        ...
        (i.fn.divide = function (n) {
            ...
            function d(i) {
                // if (((i = i.replace(options.delimiterRegExp, "")), !a(i) && i.length > 0)) return console.warn(i + " is not a number "), -1;
                    ...
                    e.bind("input.divide change.divide", function () {
                        ...
                        if (n != -1) {
                            if (!t) {
                                t = {};
                                var a = e.attr("name");
                                void 0 != a ? (e.attr("name", ""), e.parent().append("<input type='hidden' name='" + a + "'>"), (t.name = a)) : (t.name = null);
                            }
                            (t.value = i),
                                (this.value = n),
                                e.data("divided", t),
