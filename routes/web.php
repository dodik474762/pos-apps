...
use App\Http\Controllers\api\Transaction\ArSubledgerController as ApiArSubledgerController;
...
use App\Http\Controllers\web\Transaction\ArSubledgerController as WebArSubledgerController;
...
Route::get('transaksi/sales_invoice/addFromDo', [SalesInvoiceController::class, 'addFromDo'])->name('sales-invoice-add-do');
Route::get('transaksi/sales_invoice/ubah', [SalesInvoiceController::class, 'ubah'])->name('sales-invoice-edit');;
Route::get('transaksi/sales_invoice/detail', [SalesInvoiceController::class, 'detail'])->name('sales-invoice-detail');;
...
Route::post('api/master/accounts/getData', [MasterAccountsController::class, 'getData']);
...
Route::post('api/transaksi/sales_order/pilihProdukDulu', [TransactionSalesOrderController::class, 'pilihProdukDulu']);
Route::post('api/transaksi/sales_order/cekSalesman', [TransactionSalesOrderController::class, 'cekSalesman']);
...
Route::post('api/transaksi/sales_invoice/getDataFromSOCanceled', [TransactionSalesInvoiceController::class, 'getDataFromSOCanceled']);
...
Route::post('api/transaksi/sales_invoice/showModalSO', [TransactionSalesInvoiceController::class, 'showModalSO']);
Route::post('api/transaksi/sales_invoice/getDataDo', [TransactionSalesInvoiceController::class, 'getDataDo']);
Route::post('api/transaksi/sales_invoice/getDataSo', [TransactionSalesInvoiceController::class, 'getDataSo']);
...
Route::post('api/transaksi/sales_payment/submitBulk', [TransactionSalesPaymentController::class, 'submitBulk']);
...
Route::post('api/transaksi/sales_return/showModalCustomer', [TransactionSalesReturnController::class, 'showModalCustomer']);
...
Route::post('api/transaksi/sales_return/showModalPostJurnal', [TransactionSalesReturnController::class, 'showModalPostJurnal']);
Route::post('api/transaksi/sales_return/postJurnal', [TransactionSalesReturnController::class, 'postJurnal']);
...
Route::post('api/transaksi/return_cs/getData', [TransactionReturnConsigmentController::class, 'getData']);
Route::post('api/transaksi/return_cs/submit', [TransactionReturnConsigmentController::class, 'submit']);
Route::post('api/transaksi/return_cs/delete', [TransactionReturnConsigmentController::class, 'delete']);
...
Route::post('api/transaksi/packing_list/cancelPl', [TransactionPackingListController::class, 'cancelPl']);
